...
namespace psai.net
{
    ...
    {
        private static readonly string PSAI_VERSION = ".NET 1.7.0";
	    ...
	    */
        ...
        {
            return StopMusic(immediately, (int)(PSAI_FADEOUTMILLIS_STOPMUSIC * 0.001f));
        }
        ...
        internal PsaiResult MenuModeEnter(int menuThemeId, float menuIntensity)
	    {
		    ...
		    if (m_psaiPlayMode != PsaiPlayMode.menuMode)
		    {
			    ...
			    {				
				    ...
				    PlayThemeNowOrAtEndOfCurrentSegmentAndStartEvaluation(m_lastBasicMood.id, menuIntensity, 666, true, true);  // kommt raus sobald die pause funzt
			    }
